window.addEventListener('load', function(){
  ...
  function updateBodySectionChildren() {
    ...
    for(var i=0; i<bodySectionChildenNum; i++){
      ...
      bodySectionChilden[i].style.msTransform = 'translate3d(0, '+bodySectionChildrenTranslate+'px, 0)';
      bodySectionChilden[i].style.OTransform = 'translate3d(0, '+bodySectionChildrenTranslate+'px, 0)';
    ...
    for(var j=0; j<bodySectionChildenNum; j++){
      if(window.scrollY >= bodySectionChildenArr[j] + offsetTopHeadStart - window.innerHeight){
        ...
        bodySectionChilden[j].style.msTransform = 'translate3d(0, 0, 0)';
        bodySectionChilden[j].style.OTransform = 'translate3d(0, 0, 0)';
      }
    }
  }
    ...
    if(bodySectionChilden[bodySectionChildenNum-1].style.opacity !== '1'){
      ...
      for(var j=0; j<bodySectionChildenNumMut; j++){
        if(window.scrollY >= bodySectionChildenArr[j + (bodySectionChildenNum - bodySectionChildenNumMut)] && bodySectionChilden[j + (bodySectionChildenNum - bodySectionChildenNumMut)].style.opacity !== '1'){
          ...
          bodySectionChilden[j + (bodySectionChildenNum - bodySectionChildenNumMut)].style.msTransform = 'translate3d(0, 0, 0)';
          bodySectionChilden[j + (bodySectionChildenNum - bodySectionChildenNumMut)].style.OTransform = 'translate3d(0, 0, 0)';
    ...
    if(event.target.className.match('iam-nav--right') || event.target.parentNode.className.match('iam-nav--right') || event.target.parentNode.parentNode.className.match('iam-nav--right')){
      ...
      if(counter === 3){
        ...
        window.setTimeout(function(){
          ...
          document.querySelector('.emoji-sent').style.msTransform = 'scale(1)';
          document.querySelector('.emoji-sent').style.OTransform = 'scale(1)';
        }, 2000);
